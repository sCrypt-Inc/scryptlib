...
describe('GenericStruct  test', () => {
    ...
    describe('test genericsst_simple', () => {
        ...
        const C = buildContractClass(loadDescription('genericsst_simple.json'));
    ...
    describe('test genericsst_ctor', () => {
        ...
        const C = buildContractClass(loadDescription('genericsst_ctor.json'));
        before(() => {
            c = new C({
                x: 1n
            }, {
    ...
    describe('test genericsst.scrypt', () => {
        ...
        const C = buildContractClass(loadDescription('genericsst.json'));
        before(() => {
            c = new C({
                x: 1n
            }, {
