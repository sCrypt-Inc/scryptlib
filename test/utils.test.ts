...
describe('utils', () => {
  describe('num2bin()', () => {
    ...
    it('should raise error if the number can not fit in certain bytes length', () => {
      ...
      expect(() => num2bin(0xffff, 2)).to.throw(
        '65535 cannot fit in 2 byte[s]'
      );
    });
  });
  ...
  describe('int2Asm()', () => {
    it('int string to asm', () => {
      expect(
        int2Asm(
          '992218700866541488854030164190743727617658394826382323005192752278160641622424126616186015754450906117445668830393086070718237548341612508577988597572812'
        )
      ).to.equal(
  ...
  describe('parseLiteral()', () => {
    it('parser Literal string', () => {
      expect(parseLiteral('9007199254740991')).to.have.members([
        'ffffffffffff1f',
        BigInt(9007199254740991),
        'int',
      ]);
      expect(parseLiteral('0xdebc9a78563')).to.have.members([
        '6385a7c9eb0d',
        15306351674723,
        'int',
      ]);
      ...
      expect(parseLiteral('-111111')).to.have.members([
        '07b281',
        -111111,
        'int',
      ]);
      expect(parseLiteral('false')).to.have.members([
        'OP_FALSE',
        false,
        'bool',
      ]);
      expect(parseLiteral("b''")).to.have.members(['OP_0', '', 'bytes']);
      expect(parseLiteral("b'62f0245bb9'")).to.have.members([
        '62f0245bb9',
        '62f0245bb9',
        'bytes',
      ]);
      ...
      expect(
        parseLiteral(
          'PrivKey(0x3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062)'
        )
      ).to.have.members([
      ...
      expect(
        parseLiteral(
          "PubKey(b'3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062')"
        )
      ).to.have.members([
      ...
      expect(
        parseLiteral(
          "Sig(b'3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062')"
        )
      ).to.have.members([
        '3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062',
        '3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062',
      ...
      expect(
        parseLiteral("Ripemd160(b'3847f126769a6c65d281d925f9ff99')")
      ).to.have.members([
        '3847f126769a6c65d281d925f9ff99',
        '3847f126769a6c65d281d925f9ff99',
        'Ripemd160',
      ]);
      expect(
        parseLiteral("Sha1(b'3847f126769a6c65d281d925f9ff99')")
      ).to.have.members([
        '3847f126769a6c65d281d925f9ff99',
        '3847f126769a6c65d281d925f9ff99',
        'Sha1',
      ...
      expect(
        parseLiteral("Sha256(b'3847f126769a6c65d281d925f9ff99')")
      ).to.have.members([
        '3847f126769a6c65d281d925f9ff99',
        '3847f126769a6c65d281d925f9ff99',
        'Sha256',
      ]);
      expect(parseLiteral("SigHashType(b'01')")).to.have.members([
        '01',
        0x01,
        'SigHashType',
      ]);
      expect(parseLiteral("SigHashType(b'02')")).to.have.members([
        '02',
        0x02,
        'SigHashType',
      ]);
      expect(parseLiteral("SigHashType(b'03')")).to.have.members([
        '03',
        0x03,
        'SigHashType',
      ]);
      expect(parseLiteral("SigHashType(b'40')")).to.have.members([
        '40',
        0x40,
        'SigHashType',
      ]);
      expect(parseLiteral("SigHashType(b'80')")).to.have.members([
        '80',
        0x80,
        'SigHashType',
      ]);
      expect(
        parseLiteral("SigHashPreimage(b'3847f126769a6c65d281d925f9ff99')")
      ).to.have.members([
        '3847f126769a6c65d281d925f9ff99',
        '3847f126769a6c65d281d925f9ff99',
        'SigHashPreimage',
      ]);
      expect(parseLiteral("OpCodeType(b'01')")).to.have.members([
        '01',
        '01',
        'OpCodeType',
      ]);
      ...
      expect(parseLiteral("b'0001'")).to.have.members([
        '0001',
        '0001',
        'bytes',
      ]);
  ...
  describe('literal2ScryptType()', () => {
    it('literal2ScryptType', () => {
      expect(literal2ScryptType('9007199254740991').value).to.equal(
        BigInt(9007199254740991)
      );
      expect(literal2ScryptType('0xdebc9a78563').value).to.equal(
        15306351674723
      );
      ...
      expect(literal2ScryptType('PrivKey(1)').toLiteral()).to.equal(
        'PrivKey(0x01)'
      );
      ...
      expect(
        literal2ScryptType("Ripemd160(b'3847f126769a6c65d281d925f9ff99')").value
      ).to.equal('3847f126769a6c65d281d925f9ff99');
      expect(
        literal2ScryptType(
          "Ripemd160(b'3847f126769a6c65d281d925f9ff99')"
        ).toLiteral()
      ).to.equal("Ripemd160(b'3847f126769a6c65d281d925f9ff99')");

      expect(
        literal2ScryptType("Sha1(b'3847f126769a6c65d281d925f9ff99')").value
      ).to.equal('3847f126769a6c65d281d925f9ff99');
      expect(
        literal2ScryptType(
          "Sha1(b'3847f126769a6c65d281d925f9ff99')"
        ).toLiteral()
      ).to.equal("Sha1(b'3847f126769a6c65d281d925f9ff99')");

      expect(
        literal2ScryptType("Sha256(b'3847f126769a6c65d281d925f9ff99')").value
      ).to.equal('3847f126769a6c65d281d925f9ff99');
      expect(
        literal2ScryptType(
          "Sha256(b'3847f126769a6c65d281d925f9ff99')"
        ).toLiteral()
      ).to.equal("Sha256(b'3847f126769a6c65d281d925f9ff99')");

      expect(literal2ScryptType("SigHashType(b'01')").value).to.equal(0x01);
      expect(literal2ScryptType("SigHashType(b'80')").value).to.equal(0x80);
      expect(literal2ScryptType("SigHashType(b'01')").toLiteral()).to.equal(
        "SigHashType(b'01')"
      );

      expect(
        literal2ScryptType("SigHashPreimage(b'3847f126769a6c65d281d925f9ff99')")
          .value
      ).to.equal('3847f126769a6c65d281d925f9ff99');
      expect(
        literal2ScryptType(
          "SigHashPreimage(b'3847f126769a6c65d281d925f9ff99')"
        ).toLiteral()
      ).to.equal("SigHashPreimage(b'3847f126769a6c65d281d925f9ff99')");

      expect(literal2ScryptType("OpCodeType(b'01')").value).to.equal('01');
      expect(literal2ScryptType("OpCodeType(b'01')").toLiteral()).to.equal(
        "OpCodeType(b'01')"
      );
    });
  });
  ...
  describe('checkArray()', () => {
    ...
    it('checkArray int[2][1][3]', () => {
      expect(checkArray([[[3, 3, 3]], [[3, 12, 3]]], ['int', [2, 1, 3]])).to
        .true;
    });

    it('checkArray int[2][1][3]', () => {
      expect(checkArray([[[3, 3, 3], 1], [[3, 12, 3]]], ['int', [2, 1, 3]])).to
        .false;
    });
  ...
  describe('flatternArray()', () => {
    ...
    it('flatternArray int[1][1][1][2]', () => {
      expect(
        flatternArray([[[[3, 4]]]], 'a', 'int[1][1][1][2]')
      ).to.deep.ordered.members([
        {
          name: 'a[0][0][0][0]',
          type: 'int',
